...
| stalezero canary UserUpdated --userId=123 | pass | Canary: UserUpdated |
| stalezero drift User 123 | pass | Drift detected. |
...
| stalezero diagnostics | pass | Wrote <temp>\.stalezero\diagnostics.json |
